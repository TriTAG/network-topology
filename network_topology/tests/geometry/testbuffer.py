...
class BufferTestCase(unittest.TestCase):
    """Test case for BufferMaker."""

    def setUp(self):
        """Create a BufferMaker with a mock logger."""
    ...
    def test_buffer_point(self):
        """Test buffering around a single point."""
        shapes = [Point(0, 0)]
    ...
    def test_remove_holes_polygon(self):
        """Test removing small internal holes."""
    ...
    def test_remove_holes_multipolygon(self):
        """Test removing small internal holes from multiple polygons."""
        bigShape = MultiPolygon([([[0, 0], [100, 0], [100, 100], [0, 100]],
                                  [[[10, 10], [20, 10], [20, 20], [10, 20]]]),
                                 ([[200, 0], [300, 0], [300, 100], [200, 100]],
                                  [[[210, 10], [215, 10], [215, 15],
                                    [210, 15]]])])
        filledShape = self.bufferMaker._removeHoles(bigShape,
                                                    minInnerPerimeter=21)
    ...
    def test_buffer_end_to_end(self):
        """Test BufferMaker in an end-to-end scenario."""
